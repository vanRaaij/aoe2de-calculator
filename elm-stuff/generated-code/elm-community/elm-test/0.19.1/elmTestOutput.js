...
var $author$project$Resources$Cost = F2(
	function (resources, buildTime) {
		return {buildTime: buildTime, resources: resources};
	});
var $author$project$Resources$food = F2(
	function (f, _v0) {
		var resources = _v0.resources;
		var buildTime = _v0.buildTime;
...
var $author$project$Resources$gold = F2(
	function (g, _v0) {
		var resources = _v0.resources;
		var buildTime = _v0.buildTime;
		var newResources = _Utils_update(
...
var $author$project$Resources$stone = F2(
	function (s, _v0) {
		var resources = _v0.resources;
		var buildTime = _v0.buildTime;
		var newResources = _Utils_update(
...
var $author$project$Resources$time = F2(
	function (t, c) {
		return _Utils_update(
			c,
			{buildTime: t});
...
var $author$project$Resources$cost0 = {
	buildTime: 0,
	resources: {food: 0, gold: 0, stone: 0, wood: 0}
};
var $author$project$Resources$withCostOf = $author$project$Resources$cost0;
...
var $author$project$Resources$wood = F2(
	function (w, _v0) {
		var resources = _v0.resources;
		var buildTime = _v0.buildTime;
		var newResources = _Utils_update(
...
var $author$project$ResourcesTest$suite = A2(
	...
	_List_fromArray(
		[
			...
			function (n) {
				var cost = A2($author$project$Resources$food, n, $author$project$Resources$withCostOf);
				return A2($elm_explorations$test$Expect$equal, n, cost.resources.food);
			}),
			A3(
			$elm_explorations$test$Test$fuzz,
			$elm_explorations$test$Fuzz$int,
			...
			function (n) {
				var cost = A2($author$project$Resources$wood, n, $author$project$Resources$withCostOf);
				return A2($elm_explorations$test$Expect$equal, n, cost.resources.wood);
			}),
			A3(
			$elm_explorations$test$Test$fuzz,
			$elm_explorations$test$Fuzz$int,
			...
			function (n) {
				var cost = A2($author$project$Resources$stone, n, $author$project$Resources$withCostOf);
				return A2($elm_explorations$test$Expect$equal, n, cost.resources.stone);
			}),
			A3(
			$elm_explorations$test$Test$fuzz,
			$elm_explorations$test$Fuzz$int,
			...
			function (n) {
				var cost = A2($author$project$Resources$gold, n, $author$project$Resources$withCostOf);
				return A2($elm_explorations$test$Expect$equal, n, cost.resources.gold);
			}),
			A3(
			$elm_explorations$test$Test$fuzz,
			...
			function (n) {
				var cost = A2($author$project$Resources$time, n, $author$project$Resources$withCostOf);
				return A3(
					$elm_explorations$test$Expect$within,
					$elm_explorations$test$Expect$Relative(0.0001),
					n,
					cost.buildTime);
			}),
			A5(
			...
			F3(
				function (_v0, _v1, t) {
					...
					var g = _v1.b;
					var cost = A2(
						$author$project$Resources$time,
						t,
						A2(
							$author$project$Resources$gold,
							g,
							A2(
								$author$project$Resources$stone,
								s,
								A2(
									$author$project$Resources$wood,
									w,
									A2($author$project$Resources$food, f, $author$project$Resources$withCostOf)))));
					return A2(
						$elm_explorations$test$Expect$all,
						_List_fromArray(
							[
								function (c) {
								return A2($elm_explorations$test$Expect$equal, f, c.resources.food);
							},
								function (c) {
								return A2($elm_explorations$test$Expect$equal, w, c.resources.wood);
							},
								function (c) {
								return A2($elm_explorations$test$Expect$equal, s, c.resources.stone);
							},
								function (c) {
								return A2($elm_explorations$test$Expect$equal, g, c.resources.gold);
							},
								function (c) {
								return A3(
									$elm_explorations$test$Expect$within,
...
var $author$project$Test$Generated$Main1436363166$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/home/travis/build/vanRaaij/aoe2de-calculator/tests/ResourcesTest.elm']),
		processes: 2,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 259662697645664
	},
	$elm_explorations$test$Test$concat(
		_List_fromArray(
			[
				...
				'ResourcesTest',
				_List_fromArray(
					[$author$project$ResourcesTest$suite]))
			])));
_Platform_export({'Test':{'Generated':{'Main1436363166':{'init':$author$project$Test$Generated$Main1436363166$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-4991.sock";
